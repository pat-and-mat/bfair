...
download-data-adult:
	...
	curl -L http://archive.ics.uci.edu/ml/machine-learning-databases/adult/adult.data -o datasets/adult/adult.data
	curl -L http://archive.ics.uci.edu/ml/machine-learning-databases/adult/adult.test -o datasets/adult/adult.test
